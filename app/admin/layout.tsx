...
import { FiHome, FiBox, FiSettings, FiPhone, FiFileText, FiLogOut } from 'react-icons/fi';
...
export default function AdminLayout({
  ...
  // On login page and already authenticated, redirect to admin dashboard
  ...
  const menuItems = [
    ...
    { path: '/admin/general', label: 'Контент', icon: <FiFileText /> },
